                                                ...
                                                if len(rid_det):
                                                    ...
                                                    for *xyxy, rid_conf, cls in rid_det:
                                                        ...
                                                        if names[rid_c] == "LP":
                                                            ...
                                                            try:
                                                                x1, y1, x2, y2 = int(
                                                                    xyxy[0])-50, int(xyxy[1])-50, int(xyxy[2])+50, int(xyxy[3])+50
                                                            ...
                                                            with open("rider_lp.png", 'rb') as fp:
                                                                response = requests.post(
                                                                    ...
                                                                    files=dict(
                                                                        upload=fp),
                                                                    headers={'Authorization': 'Token 81b48655d3f48841b86bdd887d2e9b33a87cb317'})
                                                                try:
                                                                    rider_lp_number = response.json()[
                                                                        'results'][0]['plate']
                                                                except Exception as e:
                                                                    pass
