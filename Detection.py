    ...
    def __init__(self, top=None):
        ...
        def sendChalan(event):
            ...
            try:
                ...
                self.yag.send(to='Helmetdetection2@gmail.com', subject="Traffic Rule Challan", contents=message, attachments=data[0])
                self.yag.close()
        ...
        self.txtPassengers.place(relx=0.55, rely=0.497, height=49
                , relwidth=0.357)
        ...
        self.btnSendChallan.place(relx=0.107, rely=0.673, height=53, width=236)
        ...
        self.btnNextImage.place(relx=0.5, rely=0.673, height=53, width=256)
